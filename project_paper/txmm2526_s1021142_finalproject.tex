...
\subsection{Data}
Wikipedia pages of dairy products and countries. 
All pages are linked in this Wikipedia page: \url{https://en.wikipedia.org/wiki/List_of_dairy_products}.

\subsection{Method}
The linked Wikipedia page provides a list of dairy product and origins, answering my first subquestion. 
...
\section{Work report}
In order to find literature, I mainly looked in a online university library.
